...
function has been called with a start value as well. Thus, the first part of the function’s code establishes what
the values of the parameters are or should be. The
